...
" guibg = black
hi  NonText      guifg=#a050a0 gui=NONE      ctermfg=13    ctermbg=0    cterm=NONE

hi  Cursor       guifg=NONE guibg=NONE gui=REVERSE      ctermfg=0     ctermbg=11   cterm=reverse
hi  LineNr       guifg=#707070 guibg=#101010 gui=NONE      ctermfg=237   ctermbg=0    cterm=NONE
...
hi  Visual       guifg=NONE    guibg=#666D91 gui=NONE      ctermfg=NONE  ctermbg=237  cterm=NONE

" guibg = black
hi  SpecialKey   guifg=#4e4e4e gui=NONE      ctermfg=239   ctermbg=0    term=NONE
...
if version >= 700
  hi CursorLine   guifg=NONE    guibg=#303030 gui=BOLD      ctermfg=NONE ctermbg=16  cterm=NONE
  hi CursorColumn   guifg=NONE    guibg=#303030 gui=NONE      ctermfg=NONE ctermbg=16  cterm=NONE
...
"}}}
" Syntax highlighting"{{{
hi Comment     guifg=#a0a0d0 guibg=NONE    gui=ITALIC ctermfg=240 ctermbg=NONE cterm=NONE
...
"}}}
" VimDiff colors"{{{
hi DiffAdd     guifg=NONE guibg=#005f00    gui=NONE   ctermfg=250 ctermbg=22 cterm=NONE
hi DiffChange  guifg=NONE guibg=#875fd7    gui=NONE   ctermfg=250 ctermbg=98 cterm=NONE
hi DiffDelete  guifg=NONE guibg=#870000    gui=NONE   ctermfg=183 ctermbg=88 cterm=NONE
hi DiffText    guifg=NONE guibg=#883888    gui=NONE   ctermfg=232 ctermbg=207 cterm=BOLD
"}}}
" Spelling"{{{
